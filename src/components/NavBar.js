        ...
        <div className='container mx-auto flex justify-between'>
            <nav className='flex'>
                ...
                Kaushik</NavLink>
                  ...
                  <NavLink exact to="/project" className=" inline-flex items-center py-3 px-3 my-6 rounded text-green-800 hover:text-pink-800" activeclassName="text-red-100 bg-red-700">Projects</NavLink>
